...
#define BUTTON_PIN 15        // GPIO 15 - disponible (cambiado de GPIO 0)
...
void readSensors() {
  ...
  // GSR from analog pin
  gsr = analogRead(GSR_PIN); // Changed to use define
...
void triggerEmergency() {
  ...
  // Emergency stays active until reset
}
